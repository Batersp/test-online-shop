...
test('the product must be removed', () => {
    let product = {id: 2, count: 1, description: 'gamin langtop', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQE26ECRGgWEeD5FSfYRB5a0gvkLvwuUAk0xQ&usqp=CAU', name: 'Laptop', price: 1250}
